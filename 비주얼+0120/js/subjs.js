...
/*          sub  -   tab - 카드이용안내       */
	...
	$(function(){
	    $(".ctab > li > a:first").css({   "borderColor":"#e56e6e", "color":"#333"   });
		$(".cpanel:not(:first)").hide();
	
		$(".ctab > li > a").click(function(){
			$(".ctab li a").css({"borderBottom":"", "color":""});
			$(this).css({"borderColor":"#e56e6e", "color":"#333"});
			$(".cpanel").hide();
			$( $(this).attr("href") ).show();
...
/*          sub  -   tab - 커뮤니티        */
		...
		$(function(){
			$(".ctab.m5 > li > a:first").css({   "borderColor":"#e56e6e", "color":"#333"   });
			$(".cpanel:not(:first)").hide();
		
			$(".ctab.m5 > li > a").click(function(){
				$(".ctab.m5 li a").css({"borderBottom":"", "color":""});
				$(".ctab.m5 .cpanel").hide();
				$( $(this).attr("href") ).show();
    ...
    $(function(){
        ...
        $(".arrco dt").click(function(){
            if($(this).next().css("display") == "none")
            {
				...
				$(".faqdown").attr("src", "images/faq_down.png"); 
